...
public class Scanner
{
	...
	/**
	 * Fills the set that is utilized by the scanner to determine valid whitespace characters
	 */
	...
	/**
	 * Fills the set that is utilized by the scanner to determine valid operators
	 */
	...
	/**
	 * Takes the input program to scan through and to generate tokens from, utilizes a position counter to determine its location while scanning
	 */
	...
	/**
	 * Helper function to notify the scanner if it has scanned through the whole program
	 * @return 
	 */
	public boolean done()
	{
	...
	/**
	 * Attempts to form the largest, valid, meaningful token by incrementing the position counter of the scanner until a new, unknown character has been found.
	...
	/**
	 * Scans the next number regardless of its length and creates a token out of it
	 */
	...
	/**
	 * Endeavors to make the largest meaningful id out of letters and digits and creates a token out of it
	 */
	...
	/**
	 * Creates a token out of the next operator whether it be a two character or one operator
	 */
	private void nextOp()
	{
		int old = pos;
	 ...
	 * @return - returns false when the scanner is done scanning through the input program
	 */
	public boolean next()
	{
		if (done())
