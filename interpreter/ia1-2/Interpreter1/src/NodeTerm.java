/**
 * The "term" terminal node. This node is one of the higher level data types in the grammar which contains facts, mulops and terms
 * @author buff
 */
public class NodeTerm extends Node {
	 ...
	 * @param expr  - the term to combine with the called term
	 */
